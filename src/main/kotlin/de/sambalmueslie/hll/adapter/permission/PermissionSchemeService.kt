...
class PermissionSchemeService(private val repository: PermissionSchemeRepository) {
    ...
    companion object {
        val logger: Logger = LoggerFactory.getLogger(PermissionSchemeService::class.java)
        const val READ_ROLE = "permission.scheme.read"
        const val WRITE_ROLE = "permission.scheme.write"
    }
